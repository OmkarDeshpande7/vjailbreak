...
| The estate figures in the design do not reconcile (report shows 6.8 days / 14.6 baseline; inventory shows 2.0 / 2.1) | Loss of customer trust in the headline number | One canonical estimator owns every figure; reconciliation asserted by test (SC-005, FR-030) |
